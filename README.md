...
- 2026-06-05：同步上游 `mattpocock/skills@aaf2453`，本地提交待补。更新 `to-prd` 的 seam-based 测试决策指导，并强化 in-progress `teach` explainers 的 citations 与 interactivity 要求。
...
- [x] README 同步记录指向最新上游 `aaf2453`，本地同步提交将在提交后补齐。
